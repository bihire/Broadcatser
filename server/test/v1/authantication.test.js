...
describe('Authantication', () => {
    ...
    describe('Signup', () => {
        it('User should recieve error about first name', (done) => {
            setTimeout(done, 300);
            supertest('http://localhost:8081/api/v1')
                .post('/auth/signup')
                .set('Accept', 'application/json')
    ...
    describe('Signup', () => {
        it('User should recieve error about last name', (done) => {
            setTimeout(done, 300);
            supertest('http://localhost:8081/api/v1')
                .post('/auth/signup')
                .set('Accept', 'application/json')
    ...
    describe('Signup', () => {
        it('User should recieve error about email', (done) => {
            setTimeout(done, 300);
            supertest('http://localhost:8081/api/v1')
                .post('/auth/signup')
                .set('Accept', 'application/json')
    ...
    describe('Signup', () => {
        it('User should recieve error about password', (done) => {
            setTimeout(done, 300);
            supertest('http://localhost:8081/api/v1')
                .post('/auth/signup')
                .set('Accept', 'application/json')
    ...
    describe('Signup', () => {
        it('User should recieve error about confirmPassword', (done) => {
            setTimeout(done, 300);
            supertest('http://localhost:8081/api/v1')
                .post('/auth/signup')
                .set('Accept', 'application/json')
