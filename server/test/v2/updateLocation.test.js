  ...
  describe("Update location", () => {
    it("User should receive an error message about jwt token validation", done => {
      supertest("http://localhost:8080/api/v2")
        ...
        .set(
          "token",
          "egJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..35BfeXMkhkFWvh6CbQiTMxyUBl5O9V8-zIqrC_ewivU"
        )
    ...
    describe("delete specific red-flag/intervention", () => {
      it("User should receive an error about red-flag/intervention not found message", done => {
        supertest("http://localhost:8080/api/v2")
          ...
          .set(
            "token",
            "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiaXNBZG1pbiI6dHJ1ZSwiaWF0IjoxNTc1Mjg0MzE0fQ.h63MpVqFhQVBFunnFS9f4-_VqsdbGhozMt62c0Zgkzc"
          )
          .expect("Content-Type", /json/)
          .end((err, res) => {
            res.should.have.status(404);
